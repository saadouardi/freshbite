...
export const NewsLetter = () => {
    return (
        <section className='Newsletter'>
            <div className='Main-Newsletter Flex-Center'>
                <div className='Flex-Center'>
                    ...
                    <div className='title-description Flex-Center Flex-Column'>
                        <h3>Get the latest Blogs and offers</h3>
                        <h1>Subscribe to our Blogsletter</h1>
                    </div>
                </div>
